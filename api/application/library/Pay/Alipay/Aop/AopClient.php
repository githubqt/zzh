...
require_once (APPLICATION_PATH . "/application/library/Pay/Alipay/Aop/AopEncrypt.php");
use Pay\Alipay\Aop\SignData;
use Custom\YDLib;
...
class AopClient {
	 ...
	 * 
	 * @param $data 待签名字符串        	
	 * @param $privatekey 商户私钥，根据keyfromfile来判断是读取字符串还是读取文件，false:填写私钥字符串去回车和空格
	 *        	true:填写私钥文件路径
	 * @param $signType 签名方式，RSA:SHA1
	 *        	RSA2:SHA256
				...
				} else // 文件上传用multipart/form-data，否则用www-form-urlencoded
{
	...
	public function execute($request, $authToken = null, $appInfoAuthtoken = null) {
		...
		YDLib::testlog ( 'requestUrl......' );
		YDLib::testlog ( $requestUrl );
		YDLib::testlog ( 'apiParams......' );
		YDLib::testlog ( $apiParams );
		// 发起HTTP请求
		try {
