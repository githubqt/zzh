...
class SupplierModel extends \BaseModel {
	...
	public static function getList($attribute = array(), $page = 1, $rows = 10) {
		...
		$filed = "id,company,province_id,city_id,area_id,address,contact,mobile,created_at";
     ...
     * @return mixed
     */
    public static function getshopNameBySupplierId($supplier_id)
    {
    	$row = self::find($supplier_id,['shop_name']);
