<?php
	...
	$_maxsize = 104857600;
	$_allowtype = array("mp4", "rmvb", "mov","flv","avi");
	$_allowtypeFile = array('mpeg','dat','mp4',"3gp", "mov", "rm","ram","rmvb",'wmv','asf','avi','asx','flv');
	$_israndname = TRUE;
	#!! IMPORTANT:
    ...
    if ($upload->upload("file")) {
        //$size = $upload->getTime($_SERVER['HTTP_HOST']."/upload/".$path.$upload->getFileName());
        /*获取上传后文件名子*/
  	   $jsonData['code'] = 200;
	   $jsonData['msg'] = '上传成功';
