...
var fields =  [ [ {
    ...
    formatter:function(value, row, index){  
        ...
        str += '<input type="button" onclick="location.href=\'/?m=Marketing&c=Seckill&a=buyUserList&id='+row.id+'\'" class="easyui-linkbutton" data-options="selected:true" value="购买列表" >';
