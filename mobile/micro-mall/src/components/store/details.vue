<template>
    <section class="details-container">
        ...
        <div v-show="detailsData.is_return==1" class="details-seckill-txt">
            <span style="font-size: .3rem;font-weight:bold">不退货声明：</span>
            <div style="font-size: .24rem;">1. 由于绝当品的特殊性，购买后非质量问题不支持退换货;</div>
            <div style="font-size: .24rem;">2. 若因商品质量问题退货时，请先与卖家沟通;</div>
            <div style="font-size: .24rem;">3. 为保证商品安全，邮寄商品时请使用顺丰速运，请勿货到付款;</div>
            <div style="font-size: .24rem;">4. 卖家收到商品后，会对退货商品进行鉴定确认，确认无误后才可退款。</div>
        </div>
...
<style>
@import "../../assets/css/components/store/details";
</style>
