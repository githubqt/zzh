...
include_once(APPLICATION_PATH.'/application/library/barcodegen/class/BCGBarcode.php');
include_once(APPLICATION_PATH.'/application/library/barcodegen/class/BCGFontPhp.php');
include_once(APPLICATION_PATH.'/application/library/barcodegen/class/BCGFontFile.php');
use lib\barcode\{BCGArgumentException,BCGBarcode,BCGFontPhp,BCGFontFile};
