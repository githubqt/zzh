 ...
 */
include_once(APPLICATION_PATH.'/application/library/barcodegen/class/BCGColor.php');
include_once(APPLICATION_PATH.'/application/library/barcodegen/class/BCGLabel.php');
include_once(APPLICATION_PATH.'/application/library/barcodegen/class/BCGArgumentException.php');
include_once(APPLICATION_PATH.'/application/library/barcodegen/class/BCGDrawException.php');
use lib\barcode\{BCGColor,BCGLabel,BCGArgumentException,BCGDrawException};
