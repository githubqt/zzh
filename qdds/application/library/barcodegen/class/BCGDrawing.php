...
include_once(APPLICATION_PATH.'/application/library/barcodegen/class/drawer/BCGDrawJPG.php');
include_once(APPLICATION_PATH.'/application/library/barcodegen/class/drawer/BCGDrawPNG.php');
use lib\barcode\{BCGBarcode,BCGDrawJPG,BCGDrawPNG};
class BCGDrawing {
