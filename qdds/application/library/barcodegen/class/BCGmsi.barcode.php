 ...
 */
include_once(APPLICATION_PATH.'/application/library/barcodegen/class/BCGParseException.php');
include_once(APPLICATION_PATH.'/application/library/barcodegen/class/BCGArgumentException.php');
include_once(APPLICATION_PATH.'/application/library/barcodegen/class/BCGBarcode1D.php');
use lib\barcode\{BCGParseException,BCGArgumentException,BCGBarcode1D};
