...
include_once(APPLICATION_PATH.'/application/library/barcodegen/class/BCGean13.barcode.php');
use lib\barcode\{BCGParseException,BCGArgumentException,BCGean13};
