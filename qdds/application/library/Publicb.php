...
class Publicb
{
    ...
    */
	 ...
	 * @param int    $w 生成图片的宽度
	 * @param int    $h 生成图片的高度
	 * @param string $session  生成session的名称
	 * @return img
	 */
	public function getCode($num,$w,$h,$session = NULL)
	{
	 ...
	 * @return pdf
	 */
	public function out_pdf($html, $name)
	{
     ...
     * @return pdf
     */
    public function out_xls($data,$name)
    {
        $_loader = new \Houhouyun\Loader(APP_PATH, APP_PATH . '/../houhouyun');
    ...
    {
        $_CLASSIFY = array(1=>'head',2=>'tosu',3=>'diandnag',4=>'other');
        ...
        $filename = date("YmdHis") . md5($url) . $exf;
